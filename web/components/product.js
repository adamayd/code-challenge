    ...
    <div className="block2">
      ...
      <div className="block2-txt p-t-20">
        ...
        {product.oldPrice
          ? (
            <>
              <span className="block2-oldprice m-text7 p-r-5">{(product.oldPrice * monetaryModifier).toFixed(2)}</span>
              <span className="block2-newprice m-text8 p-r-5">{(product.price * monetaryModifier).toFixed(2)}</span>
            </>
          )
